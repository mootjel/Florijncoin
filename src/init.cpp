    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Florijncoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  florijncoind [options]                     " + "\n" +
                  "  florijncoind [options] <command> [params]  " + _("Send command to -server or florijncoind") + "\n" +
                  "  florijncoind [options] help                " + _("List commands") + "\n" +
                  "  florijncoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: florijncoind.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Florijncoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Florijncoin is probably already running."), strDataDir.c_str()));
