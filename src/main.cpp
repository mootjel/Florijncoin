...
#if defined(NDEBUG)
# error "Florijncoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xf765c18b542a5a6faa2b7dc346fbc8021d95bb6190e4cddebe99eaa950ca4a1d");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Florijncoin: starting difficulty is 1 / 2^12
...
{
    // Florijncoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 10000); // Florijncoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Florijncoin: 3.5 days
static const int64 nTargetSpacing = 5 * 60; // Florijncoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Florijncoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Florijncoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbd988c8974a0f29de8bcf611647c98dd501155d6529a204ec91e7eda6f87de5c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Hackteam AIVD gaf FBI cruciale info over Russische inmenging verkiezingen";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 20 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04d9b8895df21c896939fc41d3e8edca93490c81d191a7fa726da716995d57921381795a68bd34aadb5b9f1afed64045b3886b27382fdec60198c265a1f5f9a1e0") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1516986332;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2088167166;

        if (fTestNet)
        {
            block.nTime    = 1516986304;
            block.nNonce   = 385357303;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x404534ed0fd414619e577e15b25811f69c5c00d097641a8bcbe691dce5b5c4b0"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc5, 0xb2, 0xd3 }; // Florijncoin: increase each by adding 2 to bitcoin's value.
...
void static FlorijncoinMiner(CWallet *pwallet)
{
    ...
    RenameThread("florijncoin-miner");
    ...
    try { loop {
        ...
        printf("Running FlorijncoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("FlorijncoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&FlorijncoinMiner, pwallet));
}
